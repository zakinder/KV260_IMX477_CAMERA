...
struct reginfo mode1_default[]={	//default register settings, Resolution and FPS specific settings will be over written
...
/* 2x2 binned.  */
struct reginfo mode_2028x1520_regs[] = {
	{REG_LINE_LEN_MSB, 0x31},
	{REG_LINE_LEN_LSB, 0xc4},
	{REG_X_ADD_STA_MSB, 0x00},
	{REG_X_ADD_STA_LSB, 0x00},
...
struct reginfo mode1_1920x1080p_regs[] =
{
        {REG_LINE_LEN_MSB, 0x31},
        {REG_LINE_LEN_LSB, 0xc4},
        {0x0344, 0x00},
...
struct reginfo mode2_1920x1080p_regs[] =
{
    /* MIPI output setting */
	{REG_CSI_FORMAT_C, 0x0A},
	{REG_CSI_FORMAT_D, 0x0A},
...
int imx477_sensor_init(XIicPs *IicInstance,u16 config_number)
{
    ...
    while( address < 255 ) {
       ...
       if(sensor_id[0] == 0x4 || sensor_id[1] == 0x77) {
        ...
        imx477_read(IicInstance, 0x0016, &sensor_id[0]);
        imx477_read(IicInstance, 0x0017, &sensor_id[1]);
