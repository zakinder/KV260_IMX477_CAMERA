...
# -- - new script version
# -- - modify , script_vivado.tcl script_usrcommmands.tcl
# ------------------------------------------
...
namespace eval ::TE {
  ...
  # -----------------------------------
  # check csv file ids
  variable SCRIPTVER    "2020.2.9"
  variable BOARDDEF_CSV "1.4"
  variable SW_IP_CSV    "2.4"
  variable BDMOD_CSV    "1.1"
  variable ZIP_CSV      "1.0"
  variable PROD_CFG_CSV "1.0"
  # -----------------------------------
  ...
  # -----------------------------------------------------------------------------------------------------------------------------------------
    ...
    proc print_environment_settings {} {
      ...
      TE::UTILS::te_msg TE_INIT-1 INFO "Script Environment:\n \
        ...
        SDSOC Setting(obsolete):	$TE::SDSOC_AVAILABLE \n \
        ------"
