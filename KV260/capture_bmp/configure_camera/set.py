...
class MyWindow:
    def __init__(self, win):
        ...
        self.LABELA1_ENTER_MSB.insert(0, "1000")
        self.LABELA1_ENTER_LSB=Entry(width=6)
        self.LABELA1_ENTER_LSB.insert(0, "100")
        self.LABELB1_ENTER_MSB=Entry(width=6)
        self.LABELB1_ENTER_MSB.insert(0, "100")
        self.LABELB1_ENTER_LSB=Entry(width=6)
        self.LABELB1_ENTER_LSB.insert(0, "100")
        self.LABELC1_ENTER_MSB=Entry(width=6)
        self.LABELC1_ENTER_MSB.insert(0, "1000")
        self.LABELC1_ENTER_LSB=Entry(width=6)
        self.LABELC1_ENTER_LSB.insert(0, "100")
        self.LABELA2_ENTER_MSB=Entry(width=6)
        self.LABELA2_ENTER_MSB.insert(0, "100")
        self.LABELA2_ENTER_LSB=Entry(width=6)
        self.LABELA2_ENTER_LSB.insert(0, "100")
        self.LABELB2_ENTER_MSB=Entry(width=6)
        self.LABELB2_ENTER_MSB.insert(0, "1000")
