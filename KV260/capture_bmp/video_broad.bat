...
@echo off > nul
ffmpeg -i "udp://127.0.0.0:8080?overrun_nonfatal=1&fifo_size=50000000" -vcodec libx264 -crf 0 -preset ultrafast -vf vflip -f mpegts "udp://localhost:10000" -loglevel quiet
set /a count+=1 )
