...
static const BmpMode BMODE_640x480 = {
	.bm_header = {0x42, 0x4d},
	.bm_len = {0x36, 0xb0, 0x04, 0x00},		/* file length 921600+54 bytes */
    ...
    .bm_bytes = {0x00, 0xb0, 0x04, 0x00},	/* frame length 921600 bytes */
...
static const BmpMode BMODE_1920x1080 = {
	.bm_header      = {0x42, 0x4d},
	.bm_len         = {0x36, 0xa4, 0x1f, 0x00},	/* file length 8294400+54 bytes */
	.reserved       = {0x00, 0x00, 0x00, 0x00},
	.offset         = {0x36, 0x00, 0x00, 0x00},	/* 54 bytes */
    .bm_infolen     = {0x28, 0x00, 0x00, 0x00},	/* 40 bytes */
    ...
    .color_plane    = {0x01, 0x00},
    .pixel_width    = {0x18, 0x00},			    /* pixel 32 bit true color */
    .compress       = {0x00, 0x00, 0x00, 0x00},	/* not compressed */
    .bm_bytes       = {0x00, 0xa4, 0x1f, 0x00},	/* frame length 8294400 bytes */
    .meter_width    = {0x00, 0x00, 0x00, 0x00},
    .meter_height   = {0x00, 0x00, 0x00, 0x00},
    .color_index    = {0x00, 0x00, 0x00, 0x00},
    .index_num      = {0x00, 0x00, 0x00, 0x00}
};
static const BmpMode BMODE_1920x540 = {
	.bm_header      = {0x42, 0x4d},
	.bm_len         = {0x36, 0xd2, 0x0f, 0x00},	/* file length 8294400+54 bytes */
	.reserved       = {0x00, 0x00, 0x00, 0x00},
	.offset         = {0x36, 0x00, 0x00, 0x00},	/* 54 bytes */
    .bm_infolen     = {0x28, 0x00, 0x00, 0x00},	/* 40 bytes */
    .bm_width       = {0x80, 0x07, 0x00, 0x00},	/* width 1440 */
    .bm_height      = {0x1c, 0x02, 0x00, 0x00},	/* height 1080 */
    .color_plane    = {0x01, 0x00},
    .pixel_width    = {0x18, 0x00},			    /* pixel 32 bit true color */
    .compress       = {0x00, 0x00, 0x00, 0x00},	/* not compressed */
    .bm_bytes       = {0x00, 0xd2, 0x0f, 0x00},	/* frame length 8294400 bytes */
    .meter_width    = {0x00, 0x00, 0x00, 0x00},
    .meter_height   = {0x00, 0x00, 0x00, 0x00},
    .color_index    = {0x00, 0x00, 0x00, 0x00},
    .index_num      = {0x00, 0x00, 0x00, 0x00}
...
//static const BmpMode BMODE_1920x1080 = {
//	.bm_header = {0x42, 0x4d},
//	.bm_len = {0x36, 0x90, 0x7e, 0x00},		/* file length 6220800+54 bytes */
//	.reserved = {0x00, 0x00, 0x00, 0x00},
//	.offset = {0x36, 0x00, 0x00, 0x00},		/* 54 bytes */
//    .bm_infolen = {0x28, 0x00, 0x00, 0x00},	/* 40 bytes */
//    .bm_width = {0x80, 0x07, 0x00, 0x00},	/* width 1920 */
//    .bm_height = {0x38, 0x04, 0x00, 0x00},	/* height 1080 */
//    .color_plane = {0x01, 0x00},
//    .pixel_width = {0x20, 0x00},			/* pixel 32 bit true color */
//    .compress = {0x00, 0x00, 0x00, 0x00},	/* not compressed */
//    .bm_bytes = {0x00, 0x90, 0x7e, 0x00},	/*frame length 8,294,400[7E9000] bytes . frame length 6220800[5EEC00] bytes */
//    .meter_width = {0x00, 0x00, 0x00, 0x00},
//    .meter_height = {0x00, 0x00, 0x00, 0x00},
//    .color_index = {0x00, 0x00, 0x00, 0x00},
//    .index_num = {0x00, 0x00, 0x00, 0x00}
